...
public class Credit implements Serializable {
	...
	public Credit(int dure, float montantCredit, float montantMensuelRelever, float tauxTMM, float tauxInteret) {
		super();
		this.duree = dure;
	...
	public String toString() {
		return "Credit [id=" + id + ", duree=" + duree + ", montantCredit=" + montantCredit + ", montantMensuelRelever="
				+ montantMensuelRelever + ", tauxTMM=" + tauxTMM + ", tauxInteret=" + tauxInteret + "]";
	}
